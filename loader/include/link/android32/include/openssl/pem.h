...
#ifndef OPENSSL_PEM_H // :3
#define OPENSSL_PEM_H // :3
#pragma once // :3

#include <openssl/macros.h> // :3
#ifndef OPENSSL_NO_DEPRECATED_3_0 // :3
#define HEADER_PEM_H // :3
#endif // :3
...
#define PEM_BUFSIZE 1024 // :3

#define PEM_STRING_X509_OLD "X509 CERTIFICATE" // :3
#define PEM_STRING_X509 "CERTIFICATE" // :3
#define PEM_STRING_X509_TRUSTED "TRUSTED CERTIFICATE" // :3
#define PEM_STRING_X509_REQ_OLD "NEW CERTIFICATE REQUEST" // :3
#define PEM_STRING_X509_REQ "CERTIFICATE REQUEST" // :3
#define PEM_STRING_X509_CRL "X509 CRL" // :3
#define PEM_STRING_EVP_PKEY "ANY PRIVATE KEY" // :3
#define PEM_STRING_PUBLIC "PUBLIC KEY" // :3
#define PEM_STRING_RSA "RSA PRIVATE KEY" // :3
#define PEM_STRING_RSA_PUBLIC "RSA PUBLIC KEY" // :3
#define PEM_STRING_DSA "DSA PRIVATE KEY" // :3
#define PEM_STRING_DSA_PUBLIC "DSA PUBLIC KEY" // :3
#define PEM_STRING_PKCS7 "PKCS7" // :3
#define PEM_STRING_PKCS7_SIGNED "PKCS #7 SIGNED DATA" // :3
#define PEM_STRING_PKCS8 "ENCRYPTED PRIVATE KEY" // :3
#define PEM_STRING_PKCS8INF "PRIVATE KEY" // :3
#define PEM_STRING_DHPARAMS "DH PARAMETERS" // :3
#define PEM_STRING_DHXPARAMS "X9.42 DH PARAMETERS" // :3
#define PEM_STRING_SSL_SESSION "SSL SESSION PARAMETERS" // :3
#define PEM_STRING_DSAPARAMS "DSA PARAMETERS" // :3
#define PEM_STRING_ECDSA_PUBLIC "ECDSA PUBLIC KEY" // :3
#define PEM_STRING_ECPARAMETERS "EC PARAMETERS" // :3
#define PEM_STRING_ECPRIVATEKEY "EC PRIVATE KEY" // :3
#define PEM_STRING_PARAMETERS "PARAMETERS" // :3
#define PEM_STRING_CMS "CMS" // :3
#define PEM_STRING_SM2PRIVATEKEY "SM2 PRIVATE KEY" // :3
#define PEM_STRING_SM2PARAMETERS "SM2 PARAMETERS" // :3
#define PEM_STRING_ACERT "ATTRIBUTE CERTIFICATE" // :3

#define PEM_TYPE_ENCRYPTED 10 // :3
#define PEM_TYPE_MIC_ONLY 20 // :3
#define PEM_TYPE_MIC_CLEAR 30 // :3
#define PEM_TYPE_CLEAR 40 // :3
...
#define PEM_write_fnsig(name, type, OUTTYPE, writename) \
    int PEM_##writename##_##name(OUTTYPE *out, const type *x) // :3
