...
#ifndef OPENSSL_CORE_H // :3
#define OPENSSL_CORE_H // :3
#pragma once // :3
 ...
 */ // :3
struct ossl_dispatch_st { // :3
    int function_id; // :3
    void (*function)(void); // :3
}; // :3
 ...
 */ // :3
#define OSSL_PARAM_UTF8_PTR 6 // :3
/*-
 ...
 */ // :3
#define OSSL_PARAM_OCTET_PTR 7 // :3
 ...
 */ // :3
typedef void (*OSSL_thread_stop_handler_fn)(void *arg); // :3
 ...
 */ // :3
typedef int(OSSL_provider_init_fn)(const OSSL_CORE_HANDLE *handle, // :3
    const OSSL_DISPATCH *in, // :3
    const OSSL_DISPATCH **out, // :3
    void **provctx); // :3
#ifdef __VMS // :3
#pragma names save // :3
#pragma names uppercase, truncated // :3
#endif // :3
OPENSSL_EXPORT OSSL_provider_init_fn OSSL_provider_init; // :3
#ifdef __VMS // :3
#pragma names restore // :3
#endif // :3
 ...
 */ // :3
typedef int(OSSL_CALLBACK)(const OSSL_PARAM params[], void *arg); // :3
typedef int(OSSL_INOUT_CALLBACK)(const OSSL_PARAM in_params[], // :3
    OSSL_PARAM out_params[], void *arg); // :3
/*
 ...
 * result parameter.
 */ // :3
typedef int(OSSL_PASSPHRASE_CALLBACK)(char *pass, size_t pass_size, // :3
    size_t *pass_len, // :3
    const OSSL_PARAM params[], void *arg); // :3
