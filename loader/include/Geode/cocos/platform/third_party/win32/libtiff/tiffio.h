...
#if defined(LIBTIFF_EXPORTS) // :3
#define TIFF_DLL     __declspec(dllexport) // :3
...
TIFF_DLL extern void* _TIFFmalloc(tmsize_t s); // :3
TIFF_DLL extern void* _TIFFrealloc(void* p, tmsize_t s); // :3
TIFF_DLL extern void _TIFFmemset(void* p, int v, tmsize_t c); // :3
TIFF_DLL extern void _TIFFmemcpy(void* d, const void* s, tmsize_t c); // :3
TIFF_DLL extern int _TIFFmemcmp(const void* p1, const void* p2, tmsize_t c); // :3
TIFF_DLL extern void _TIFFfree(void* p); // :3

/*
** Stuff, related to tag handling and creating custom tags.
*/ // :3
TIFF_DLL extern int TIFFGetTagListCount( TIFF * ); // :3
TIFF_DLL extern uint32 TIFFGetTagListEntry( TIFF *, int tag_index ); // :3
